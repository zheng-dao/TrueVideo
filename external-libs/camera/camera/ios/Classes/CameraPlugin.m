...
- (void)handleMethodCallAsync:(FlutterMethodCall *)call
  ...
  if ([@"availableCameras" isEqualToString:call.method]) {
    ...
    NSString *microphone = [call.arguments[@"iosMicrophone"] lowercaseString];
    AVAudioSessionPortDescription *portDescription = [[AVAudioSession sharedInstance] preferredInput];
    ...
    [result sendSuccess];
  } else if ([@"resetAudio" isEqualToString:call.method]) {
    [_camera resetAudio];
    [result sendSuccess];
  } else {
