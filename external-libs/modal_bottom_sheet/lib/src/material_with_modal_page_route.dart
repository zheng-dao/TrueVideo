...
class MaterialWithModalsPageRoute<T> extends MaterialPageRoute<T> {
  ...
  bool canTransitionTo(TransitionRoute<dynamic> nextRoute) {
    if (nextRoute is MaterialPageRoute && !nextRoute.fullscreenDialog) return true;
    if (nextRoute is CupertinoPageRoute && !nextRoute.fullscreenDialog) return true;
    if (nextRoute is MaterialWithModalsPageRoute && !nextRoute.fullscreenDialog) return true;
    if (nextRoute is ModalBottomSheetRoute) return true;
    return false;
  }
