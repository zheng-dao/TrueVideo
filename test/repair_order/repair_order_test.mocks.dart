...
// in truvideo_enterprise/test/repair_order/repair_order_test.dart.
...
import 'package:truvideo_enterprise/model/dealer_code_access_history.dart'
    as _i9;
import 'package:truvideo_enterprise/model/dealer_info.dart' as _i8;
...
import 'package:truvideo_enterprise/model/offline_enqueue/offline_enqueue_item_type.dart'
    as _i17;
import 'package:truvideo_enterprise/model/user.dart' as _i7;
import 'package:truvideo_enterprise/model/user_login.dart' as _i2;
import 'package:truvideo_enterprise/model/user_settings.dart' as _i10;
import 'package:truvideo_enterprise/service/auth/_interface.dart' as _i5;
import 'package:truvideo_enterprise/service/http/_interface.dart' as _i11;
import 'package:truvideo_enterprise/service/http/model/response.dart' as _i3;
import 'package:truvideo_enterprise/service/local_db/_interface.dart' as _i12;
import 'package:truvideo_enterprise/service/log_event/_interface.dart' as _i13;
import 'package:truvideo_enterprise/service/log_event/model/level.dart' as _i15;
...
class MockAuthService extends _i1.Mock implements _i5.AuthService {
  ...
  @override
  _i6.Future<_i7.UserModel?> getCachedLoggedUser() =>
      (super.noSuchMethod(Invocation.method(#getCachedLoggedUser, []),
              returnValue: Future<_i7.UserModel?>.value())
          as _i6.Future<_i7.UserModel?>);
  @override
  _i6.Future<_i7.UserModel?> isLogin() =>
  ...
  @override
  _i6.Future<_i8.DealerInfoModel?> getDealerInfo(String? dealerCode) =>
      (super.noSuchMethod(Invocation.method(#getDealerInfo, [dealerCode]),
              returnValue: Future<_i8.DealerInfoModel?>.value())
          as _i6.Future<_i8.DealerInfoModel?>);
  @override
  _i6.Future<List<_i2.UserLoginModel>> getUsersForDealerCode(
          String? dealerCode) =>
      (super.noSuchMethod(
          Invocation.method(#getUsersForDealerCode, [dealerCode]),
          returnValue: Future<List<_i2.UserLoginModel>>.value(
              <_i2.UserLoginModel>[])) as _i6.Future<List<_i2.UserLoginModel>>);
  @override
  ...
  DateTime? getLastAccessDate(String? userUid) =>
      (super.noSuchMethod(Invocation.method(#getLastAccessDate, [userUid]))
          as DateTime?);
  @override
  _i6.Future<_i2.UserLoginModel> create(
          {String? dealerCode,
          String? firstName,
          String? lastName,
          String? pin,
      ...
      (super.noSuchMethod(
          ...
          as _i6.Future<_i2.UserLoginModel>);
  @override
  _i6.Stream<List<_i9.DealerCodeAccessHistoryModel>>
      streamDealerCodesHistory() =>
          (super.noSuchMethod(Invocation.method(#streamDealerCodesHistory, []),
                  returnValue:
                      Stream<List<_i9.DealerCodeAccessHistoryModel>>.empty())
              as _i6.Stream<List<_i9.DealerCodeAccessHistoryModel>>);
  @override
  _i6.Future<List<_i9.DealerCodeAccessHistoryModel>> getDealerCodesHistory() =>
      (super.noSuchMethod(Invocation.method(#getDealerCodesHistory, []),
              returnValue: Future<List<_i9.DealerCodeAccessHistoryModel>>.value(
                  <_i9.DealerCodeAccessHistoryModel>[]))
          as _i6.Future<List<_i9.DealerCodeAccessHistoryModel>>);
  @override
  _i6.Future<void> validateUsernameEmail({String? email, String? username}) =>
      (super.noSuchMethod(
          ...
          returnValueForMissingStub: Future<void>.value()) as _i6.Future<void>);
  @override
  _i6.Future<_i7.UserModel?> getMyProfile() =>
      (super.noSuchMethod(Invocation.method(#getMyProfile, []),
              returnValue: Future<_i7.UserModel?>.value())
          as _i6.Future<_i7.UserModel?>);
  @override
  _i6.Future<List<_i10.UserSettingsModel>> getUserSettings() =>
      (super.noSuchMethod(Invocation.method(#getUserSettings, []),
              returnValue: Future<List<_i10.UserSettingsModel>>.value(
                  <_i10.UserSettingsModel>[]))
          as _i6.Future<List<_i10.UserSettingsModel>>);
  @override
  _i6.Future<List<_i10.UserSettingsModel>?> getCachedUserSettings() =>
...
class MockHttpService extends _i1.Mock implements _i11.HttpService {
  ...
  _i6.Future<_i3.HttpResponseModel> put(Uri? uri,
      ...
      (super.noSuchMethod(
          ...
          .Future<_i3.HttpResponseModel>);
  @override
  _i6.Future<_i3.HttpResponseModel> post(Uri? uri,
          {Map<String, dynamic>? headers = const {},
          Map<String, dynamic>? params = const {},
          dynamic data}) =>
      (super.noSuchMethod(
          ...
          .Future<_i3.HttpResponseModel>);
  @override
  _i6.Future<_i3.HttpResponseModel> delete(Uri? uri,
          {Map<String, dynamic>? headers = const {},
          Map<String, dynamic>? params = const {}}) =>
      (super.noSuchMethod(
              Invocation.method(
          ...
          as _i6.Future<_i3.HttpResponseModel>);
}
...
///
/// See the documentation for Mockito's code generation for more information.
class MockLogEventService extends _i1.Mock implements _i13.LogEventService {
  MockLogEventService() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i6.Future<void> logScreen(String? screenName) =>
      (super.noSuchMethod(Invocation.method(#logScreen, [screenName]),
          returnValue: Future<void>.value(),
          returnValueForMissingStub: Future<void>.value()) as _i6.Future<void>);
  @override
  _i6.Future<void> logEvent(_i14.LogEventModule? module,
          {String? action = r'',
          _i15.LogEventLevel? level,
          String? message = r'',
          String? raw = r'',
          int? orderID}) =>
      (super.noSuchMethod(
          ...
          returnValueForMissingStub: Future<void>.value()) as _i6.Future<void>);
  @override
  _i6.Future<void> processLog(_i14.LogEventModule? module,
          {String? action = r'',
          _i15.LogEventLevel? level,
          String? message = r'',
          String? raw = r'',
      ...
      (super.noSuchMethod(
          ...
          returnValueForMissingStub: Future<void>.value()) as _i6.Future<void>);
  @override
  _i6.Future<void> logEventError(Exception? err, StackTrace? stackTrace) =>
...
class MockOfflineEnqueueService extends _i1.Mock
    implements _i16.OfflineEnqueueService {
  ...
  _i6.Stream<List<_i4.OfflineEnqueueItemModel>> stream(
          {List<_i17.OfflineEnqueueItemType>? type = const [],
          List<_i18.OfflineEnqueueItemStatus>? status = const []}) =>
      (super.noSuchMethod(
